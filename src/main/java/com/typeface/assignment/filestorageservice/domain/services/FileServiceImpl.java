...
public class FileServiceImpl implements FileService {
    ...
    public String updateFileInS3(String fileId, MultipartFile file) {
        ...
        try {
            if (file != null && !file.isEmpty()) {
                ...
                amazonS3.putObject(new PutObjectRequest(s3BucketName, fileMetadata.getFileId(), file.getInputStream(), null));
            }
    ...
    public String generateUniqueFileKey(String fileName) {
        String nameAlphabeticOnly = fileName.replaceAll("[^a-zA-Z]", "");
        return nameAlphabeticOnly + "-S3-"+System.currentTimeMillis();
